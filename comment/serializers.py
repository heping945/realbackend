...
class CommentSubSerialziser(serializers.ModelSerializer):
    ...
    parent_id = serializers.CharField(source='parent_comment_id')
    class Meta:
        model = Comment
        fields = ('id', 'content', 'author', 'reply_to','create_time','parent_id')
...
class CommentCreateSerializer(serializers.ModelSerializer):
    # parent_comment=CommentSubSerialziser()
    # reply_to =
    class Meta:
        model = Comment
        fields = ('id', 'content', 'post', 'reply_to', 'parent_comment')
