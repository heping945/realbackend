    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('upvote_count', models.IntegerField(default=0, help_text='点赞数', verbose_name='点赞数')),
                ...
                ('category', models.ForeignKey(help_text='文章分类', on_delete=django.db.models.deletion.CASCADE, related_name='cat_post', to='blog.Category', verbose_name='分类')),
            ],
            options={
                'verbose_name': '文章',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.SlugField(blank=True, max_length=124, verbose_name='slug')),
            ],
            options={
                'verbose_name': '标签',
