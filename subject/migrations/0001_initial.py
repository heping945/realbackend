    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('title', models.CharField(help_text='标题', max_length=64, verbose_name='标题')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('title', models.CharField(help_text='标题', max_length=64, unique=True, verbose_name='标题')),
                ('urltag', models.CharField(help_text='标签', max_length=32, unique=True, verbose_name='标签')),
                ...
                ('create_date', models.DateTimeField(auto_now_add=True, help_text='创建时间', verbose_name='创建时间')),
                ('codestyle', models.CharField(blank=True, default='monokai', help_text='代码风格', max_length=24, null=True, verbose_name='代码风格')),
                ...
                ('ifshow', models.BooleanField(default=True, verbose_name='是否展示')),
            ],
            options={
                'verbose_name': '主题',
